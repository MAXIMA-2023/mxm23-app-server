                ...
                <table width="500" cellspacing="0" cellpadding="20" border="0" style="background-color: #ffffff;min-width:auto;max-width:600px; border-radius: 0.7em; box-shadow: 0 2px 10px rgba(0.4, 0.4, 0.4, 0.4);">
                  ...
                  <tr>
                    <td style="font-family: 'Nunito Sans', sans-serif; font-size: 15px; text-align: left; text-shadow: 0 2px 10px rgba(0.4, 0.4, 0.4, 0.4); margin-left: 1em; margin-right: 1em;">
                      <!-- Text Container -->
                      <p>
                        Hi, <b>${mahasiswa[i].name}</b>. Selamat datang di
                  ...
                  <tr>
                    <td align="center">
                      <!-- QR Code Image -->
                      <a href="https://maxima.umn.ac.id/malpun/tiket/${mahasiswa[i].tokenMalpun}" style="text-decoration: none; background-color: #F7B70C; color: #fff; padding: 10px 20px; border-radius: 64px; display: inline-block;">Claim Your Ticket</a><br><br>
                      <a href="https://maximaumn.com/malpun/tiket/${mahasiswa[i].tokenMalpun}" style="text-decoration: none; background-color: #F7B70C; color: #fff; padding: 10px 20px; border-radius: 64px; display: inline-block;">Alternative TIcket Claim</a>
                      </td>
                  </tr>
                </table>
              </td>
