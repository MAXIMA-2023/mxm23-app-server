    ...
    try {
        ...
        if (transaction_status == 'pending'){
            ...
            return res.status(200).json({
                ...
                code : 200, 
                message : 'Pembayaran sedang dalam status pending / menunggu aksi dari user.',
            });
        ...
        return res.status(200).json({
            status : 'SUCCESS', 
            code : 200, 
            message : 'Berhasil melakukan pemrosesan pada payment dengan status ' + transaction_status,
        });
