  ...
  try {
    ...
    if (!externalAccount) {
      return res.status(404).json({
        ...
        code: 404,
        message:
          "Tidak menemukan riwayat pembayaran. Silahkan kontak admin MAXIMA untuk penanganan lebih lanjut.",
      });
    }
  ...
  try {
    ...
    if (internalAccount) {
      return res.status(200).json({
        status: "SUCCESS",
        code: 200,
        message: "Berhasil mendapatkan data internal",
        data: {
          isInternal: true,
          name: internalAccount.name,
          token: internalAccount.tokenMalpun,
        },
      });
    }
    ...
    if (!externalAccount) {
      return res.status(404).json({
        ...
        code: 404,
        message:
          "Tidak menemukan riwayat tiket. Silahkan kontak admin MAXIMA untuk penanganan lebih lanjut.",
      });
    }
